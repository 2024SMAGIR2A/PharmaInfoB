...
<body>
    <div class="container-fluid py-2">
         <?php  $location_search = request()->query('query'); ?>
        <h2 class="text-center">Liste des Pharmacies disponible dans la zone de / du {{ $location_search }}</h2>
    </div>
                        ...
                        <table id="pharmaciesTable" class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($pharmacies as $pharmacie)
                                    <tr>
                                        <td> <img src="{{ asset('assets/img/pharmacie.png') }}" height="30px" width="30px" alt="phr"> {{ $pharmacie->nom }}</td>
...
<script>
    $(document).ready(function () {
        $('#pharmaciesTable').DataTable({
            ...
            columnDefs: [
                { targets: [2, 5], orderable: false } // Désactiver le tri pour Téléphone et Actions
            ],
