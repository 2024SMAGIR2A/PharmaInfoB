  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pharmacien</li>
      </ol>
    </nav>

    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
      <a href="{{ route('logout') }}" class="btn btn-outline-primary btn-sm mb-0 me-3" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        Déconnexion
      </a>
        ...
        <div class="row">
          ...
          <!-- Gestionnaire de pharmacie -->
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    <div class="card-header pb-0 p-3">
                        <h6>Mon gestionnaire de pharmacie</h6>
                    </div>
                    <div class="card-body p-3">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @forelse ($pharmacie_ph as $pharmacie)
                                    <tr>
                                        <td>{{ $pharmacie->nom }}</td>
                                        <td>
                                            <a href="{{ route('pharmacies.show', $pharmacie) }}" class="btn btn-primary">Gérer</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="2">Aucune pharmacie trouvée pour cet utilisateur.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    <div class="card-header pb-0 p-3">
                        <h6>Mon gestionnaire de medicaments</h6>
                    </div>
                    <div class="card-body p-3">
                        <table class="table table-striped">
                            <thead>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">Aucun medicament spécifique enregistré.</td>
                                    </tr>
