          ...
          <div class="row">
            <div class="col-md-4">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="pharmacyName" id="pharmacyName" required>
              </div>
              <div class="mb-3">
            ...
            <div class="col-md-4">
              <div class="mb-3">
                ...
                <textarea class="form-control" name="openingHours" id="openingHours" rows="3" required></textarea>
              </div>
              <div class="mb-3">
                <label for="servicesOffered" class="form-label">Services proposés</label>
                <textarea class="form-control" name="servicesOffered" id="servicesOffered" rows="3" required></textarea>
              </div>
              <div class="mb-3">
            ...
            <div class="col-md-4">
              <div class="mb-3">
                ...
                <select class="form-select" name="isOnCall" id="isOnCall">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" name="pharmacistId" id="pharmacistId" required>
              </div>
            </div>
          </div>
